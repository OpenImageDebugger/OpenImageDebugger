...
class TypeBridge(object):
    ...
    def get_inspectors(self):
        """
        The registered inspectors in precedence order (user JSON, then user
        Python subclasses, then the JSON built-ins). The conformance tool
        runs a symbol through each of these.
        """
        return list(self._type_inspectors)
